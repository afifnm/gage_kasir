<?php
	...
	$pdf->AddPage();
	$pdf->SetFont('','B',12);
	$pdf->Cell(0 ,5,'PENGELUARAN DIGITAL '.mediumdate_indo($tanggal1).' SAMPAI '.mediumdate_indo($tanggal2),0,1,'C');
	$pdf->Cell(130 ,12,'',0,0);
	...
	$pdf->MultiCell(20 ,5,'Gramatur', 1, 'C', '', 0);
	$pdf->MultiCell(40 ,5,'Keterangan', 1, 'C', '', 0);
	$pdf->MultiCell(20 ,5,'Supplier', 1, 'C', '', 0);
    ...
    foreach ($data2 as $u) {
		...
		$pdf->Cell(20 ,4,$u['gramatur'], 1, 0,'C');
		$pdf->Cell(40 ,4,$u['keterangan'],  1, 0, 'L');
		$pdf->Cell(20 ,4,$u['sup'], 1, 'C', 0);
	...
	$pdf->SetFont('','B',8);
	$pdf->MultiCell(139 ,4,'Sub  Total', 1, 'C', '', 0);
