...
<div class="col-xs-12" align="left">
  <div class="box-header">
    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#ModalDigital"><i class="fa fa-plus-square"></i> Tambah Pendapatan</button>
...
<div class="col-md-12">
  <div class="box box-solid">
    <div class="box-header">
      <h3 class="box-title" align="center">Pendapatan</h3>
    </div>
    <!-- /.box-header -->
    <div class="box-body">
      <table id="example1" class="table table-bordered table-hover">
        ...
        <td align="center">
          <a href="<?php echo site_url('admin/pengeluaran/pendapatan_hapus/'.$u['id']);?>"  class="btn btn-danger btn-xs"><i class="fa fa-trash"> Hapus</i></a>           
        </td>
        </tr>
        <?php 
        $sum = $sum+$tagihan;
    ...
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="myModalLabel" align="center">PENDAPATAN
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          </h4>
        </div>
        <div class="box-body">
          <form class="form-horizontal" method="post" action="<?php echo site_url('admin/pengeluaran/pendapatan_input');?>">
            <div class="box-body">
