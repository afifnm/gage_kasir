<?php
	...
	$pdf->AddPage();
	$pdf->SetFont('times','B',12);
	$pdf->Cell(0 ,5,'PENGELUARAN RUMAH TANGGA '.mediumdate_indo($tanggal1).' SAMPAI '.mediumdate_indo($tanggal2),0,1,'L');
	$pdf->Cell(130 ,12,'',0,0);
	...
	$pdf->MultiCell(30 ,5,'Order', 1, 'C', '', 0);
	$pdf->MultiCell(31 ,5,'Keterangan', 1, 'C', '', 0);
	$pdf->MultiCell(15 ,5,'QTY', 1, 'C', '', 0);
    ...
    foreach ($data2 as $u) {
		...
		$pdf->Cell(30 ,4,$u['gramatur'], 1, 0,'C');
		$pdf->Cell(31 ,4,$u['keterangan'],  1, 0, 'L');
		$pdf->Cell(15 ,4,$u['qty'], 1, 'C', 0);
		$pdf->Cell(20 ,4,'Rp. '.number_format($u['harga'],0,",","."), 1, 0,'R');
		$pdf->Cell(25 ,4,'Rp. '.number_format($u['qty']*$u['harga'],0,",","."), 1, 0,'R');
		$pdf->Cell(25 ,4,$u['pembayaran'], 1, 'C', 0);
	...
	$pdf->SetFont('times','B',9);
	$pdf->MultiCell(125 ,4,'Sub  Total', 1, 'C', '', 0);
	...
	$pdf->Output('pengeluaran_rm'.$tanggal1.'-'.$tanggal2.'.pdf', 'I');
?>