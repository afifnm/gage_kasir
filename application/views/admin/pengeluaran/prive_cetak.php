<?php
	...
	$pdf->Cell(0 ,5,'PENGELUARAN PRIVE '.mediumdate_indo($tanggal1).' SAMPAI '.mediumdate_indo($tanggal2),0,1,'L');
	$pdf->Cell(130 ,12,'',0,0);
	...
	$pdf->MultiCell(30 ,5,'Pembayaran', 1, 'C', '', 1);
    ...
    foreach ($data2 as $u) {
		...
		$pdf->Cell(30 ,4,$u['pembayaran'],  1, 0, 'C');
	...
	$pdf->Output('pengeluaran_prive'.$tanggal1.'-'.$tanggal2.'.pdf', 'I');
?>